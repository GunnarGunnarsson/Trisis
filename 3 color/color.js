/*
*   Leikvöllurinn - réttur litur á réttum hlutum
*
*   To do:
*
*   breyta litum fyrir hvern hlut
*   gera útlínur á kassann
*   skilgreina mörk vallarins
*   búa til nýjan kassa með nýjum lit á meðan hinn er ennþá til og helst í stað
*   útbúa coalition check
*   láta mismunandi kassa vera mismunandi í laginu
*/
...
function render()
{
    ...
    //triCube = mult( triCube, scale4( 1.0, 1.0, 1.0 ) ); // Kassinn skalaður í rétt hlutföll
